...
- `slide-step`はあくまでアニメーション用です。`slide-step`と`slide-next`は互いに干渉しない独立して動作するトリガになるようにし、`slide-step`によってスライドが次のページに移らないようにしてください。
...
- 視覚的に見やすいデザインのスライドを作成してください。図やアニメーションを使ったり、文字同士が不必要に重ならないようにレイアウトしてください。
  - 簡単な図解や図式のようなものはInline SVGで記述してください。
